<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><div align="center">
  <center>
    <a href="https://gitlab.com/megabyte-labs/packer/macos-desktop" title="macOS 11.0.0 (Big Sur) GitLab page" target="_blank">
      <img width="100" height="100" alt="macOS 11.0.0 (Big Sur) logo" src="./logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1 align="center">Packer Template: macOS 11.0.0 (Big Sur)</h1></center>
</div>
...
<div align="center">
  <h4 align="center">
    ...
    <a href="https://github.com/ProfessorManhattan/packer-macos-desktop" title="GitHub mirror" target="_blank">
  ...
  <p align="center">
    <a href="https://gitlab.com/megabyte-labs/npm/macos-desktop" target="_blank">
      <img alt="Version: 1.0.0" src="https://img.shields.io/badge/version-1.0.0-blue.svg?cacheSeconds=2592000" />
    </a>
    <a href="https://gitlab.com/megabyte-labs/packer/macos-desktop/commits/master" target="_blank">
      <img alt="Pipeline status" src="https://gitlab.com/megabyte-labs/packer/macos-desktop/badges/master/pipeline.svg">
    </a>
    <a href="https://gitlab.com/megabyte-labs/packer/macos-desktop" target="_blank">
      <img alt="Last commit date" src="https://img.shields.io/github/last-commit/ProfessorManhattan/packer-macos-desktop?logo=git&logoColor=white&style=flat" />
    </a>
    ...
    <a href="https://gitlab.com/megabyte-labs/packer/macos-desktop/-/raw/master/LICENSE" target="_blank">
...
> </br><h3 align="center">**An automated macOS Big Sur Desktop Packer project that builds boxes using the latest Big Sur sources**</h3></br>
...
If a new release of the macOS 11.0.0 (Big Sur) system is available, you can update your VagrantUp box. You can do this by changing the `"iso_checksum_url"`, `"iso_url"`, and `"iso_version"` variables in the `template.json` file. After that, run `packer build -only=virtualbox-iso template.json` and you should be golden.
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://gitlab.com/megabyte-labs/packer/macOS-Desktop/-/issues). If you would like to contribute, please take a look at the [contributing guide](https://gitlab.com/megabyte-labs/packer/macOS-Desktop/-/blob/master/CONTRIBUTING.md).
...
Copyright © 2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/packer/macOS-Desktop/-/raw/master/LICENSE) licensed.
